...
class App:
    def __init__(self):
        ...
        self.icon_figure = ImageTk.PhotoImage(Image.open(resource_path('./logo_only_mouth.png')))
        self.root.wm_iconphoto(False, self.icon_figure)
        # self.root.iconbitmap(self.icon_figure)
        ...
        # BUTTON C1 e LED 1
        self.green_led_figure_1 = ImageTk.PhotoImage(Image.open(resource_path('small_green_led.jpg')))
        self.red_led_figure_1 = ImageTk.PhotoImage(Image.open(resource_path('small_red_led.jpg')))
        ...
        # BUTTON C2 e LED 2
        self.green_led_figure_2 = ImageTk.PhotoImage(Image.open(resource_path('small_green_led.jpg')))
        self.red_led_figure_2 = ImageTk.PhotoImage(Image.open(resource_path('small_red_led.jpg')))
